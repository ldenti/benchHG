...
CXXFLAGS=-Wall -Wno-sign-compare -O0 -std=c++14 -I/home/ld/code/PaSGAL/src/include -I./vg/src -I./vg/include -fopenmp -pthread
...
# vg/obj/region.o
sveval: bcftools/smpl_ilist.o bcftools/filter.o bcftools/consensus.o main.o
	@echo "* Linking $@"
	$(CXX) $(CXXFLAGS) -o $@ $^ $(LIBS)
